...
§2A. Complements — does not replace — `docs/archive/phases/PHASE_H_RUNBOOK.md` and
`docs/archive/phases/PHASE_I_RUNBOOK.md`. Rule #4 governs *which document owns the
...
[`docs/archive/phases/PHASE_I6_CHARTER.md`](docs/archive/phases/PHASE_I6_CHARTER.md); slice plan in
...
| `ErrVendorCreditNoteStockItemRequiresReturnReceipt` on VCN post | **Q-parity controlled-mode rejection.** | Not a bug. Controlled mode requires the locked I.6b `VendorReturnShipment` path (charter: [`docs/archive/phases/PHASE_I6_CHARTER.md`](docs/archive/phases/PHASE_I6_CHARTER.md) Q2; UI label "Return to Vendor"; slice **I.6b.3** retires this rejection). Until I.6b ships, use a manual JE (Dr AP / Cr Inventory at original cost) and keep the VCN as draft or remove the stock line. |
...
| 2026-04-21 | **I.6.0** — Phase I.6 charter ([`docs/archive/phases/PHASE_I6_CHARTER.md`](docs/archive/phases/PHASE_I6_CHARTER.md)) adopted into [`INVENTORY_MODULE_API.md`](INVENTORY_MODULE_API.md) §7 Phase I.6. §10a / §10b placeholders repointed from "planned / future" to the locked charter + specific slice references (`ARReturnReceipt` / I.6a.3; `VendorReturnShipment` / I.6b.2a / I.6b.3). Q2 misnomer ("Vendor Return Receipt" → `VendorReturnShipment` with UI label "Return to Vendor") corrected in §10b. |
...
| 2026-04-21 | **I.6a.5** — `docs/archive/phases/PHASE_I6_RUNBOOK.md` (CS-facing operator runbook, AR side) + `docs/archive/phases/PHASE_I6A_PILOT_ENABLEMENT.md` (layered pilot on Phase-I-green companies, 5 pre-flight gates, daily check SQL, 3-week observation window) + `phase_i6a_smoke_test.go` (split-return 6+4 summing; void + re-post coverage restoration). AR side of Phase I.6 complete. |
...
| 2026-04-21 | **I.6b.5** — `docs/archive/phases/PHASE_I6B_PILOT_ENABLEMENT.md` (layered pilot on Phase-H-green companies; 5 gates + 6 daily SQL checks including traced-cost-match + double-count guards) + `docs/archive/phases/PHASE_I6_RUNBOOK.md` §§9–15 AP body (operator workflow, identity chain, triage, known limits, escalation) + `phase_i6b_smoke_test.go` (split-return 6+4, void + re-post coverage restoration). **Phase I.6 complete** — AP side matches AR side in depth. |
