# GoBooks 0.0.16 Release Notes

## Summary

GoBooks 0.0.16 adds the SmartPicker Recommendation + AI Learning Platform V1 foundation. The batch keeps accounting truth in backend services while adding explainable, company-isolated learning signals for faster SmartPicker recommendations.
