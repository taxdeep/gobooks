...
GoBooks AI should be understood as a company-scoped learning, recommendation, explanation, and draft-preparation layer that sits around the accounting system, not inside the accounting truth engine.
