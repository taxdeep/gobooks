...
func (s *Server) registerRoutes(app *fiber.App) {
	...
	// AR Phase 1: route stubs (Phase 2-5 will replace these with real handlers)
	// Quotes (Phase 2)
	app.Get("/quotes", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleQuoteList)
	app.Get("/quotes/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleQuoteNew)
	app.Post("/quotes", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleQuoteCreate)
	app.Get("/quotes/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleQuoteDetail)
	app.Post("/quotes/:id/update", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleQuoteUpdate)
	...
	app.Get("/sales-orders", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleSalesOrderList)
	app.Get("/sales-orders/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleSalesOrderNew)
	app.Post("/sales-orders", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleSalesOrderCreate)
